...
public class Mono {
    ...
    private int exp;
    private final HashMap<Poly,Integer> sinList = new HashMap<>();
    private final HashMap<Poly,Integer> cosList = new HashMap<>();
    ...
    public String toString() {
        ...
        return doStringBuilder(sb);
    }

    public String doStringBuilder(StringBuilder sb) {
